...
export class SessionManager {
    ...
    async loadSession(sessionId) {
        try {
            ...
            console.log('🔧 SessionManager: Raw data from server:', data);
            console.log('🔧 SessionManager: Session data configuration:', this.sessionData?.configuration);
    ...
    updateConfiguration(config) {
        if (!this.sessionData) {
            console.error('❌ updateConfiguration: No sessionData available');
            return;
        }

        console.log('🔧 SessionManager: Updating configuration with:', config);
        console.log('🔧 SessionManager: Current sessionData before update:', this.sessionData);
        ...
        console.log('🔧 SessionManager: Updated configuration:', this.sessionData.configuration);
