...
export class ModelSelector {
    constructor(sceneManager, availableModels = []) {
        ...
        // Basic test models if none provided
            ...
            <div class="model-selector-container">
                <div class="model-selector">
                    ...
                    <div class="model-controls">
                        <button id="prev-model" class="model-nav-btn" ${this.currentModelIndex === 0 ? 'disabled' : ''}>
                            ◀ Previous
                        </button>
                        ...
                        <button id="next-model" class="model-nav-btn" ${this.currentModelIndex === this.availableModels.length - 1 ? 'disabled' : ''}>
                            Next ▶
                        </button>
                    </div>
                    ...
                    <div class="cache-status">
                        ...
                        <div class="cache-actions">
                            <button id="optimize-memory" class="cache-action-btn" title="Optimize memory usage">
                                🧹 Optimize
                            </button>
                            <button id="preload-all" class="cache-action-btn" title="Preload all models">
                                📦 Preload All
                            </button>
                        </div>
                    </div>
    ...
    attachEventListeners() {
        ...
        const preloadAllBtn = document.getElementById('preload-all');
    ...
    updateUISelection(modelIndex) {
        ...
        if (prevBtn) {
            prevBtn.disabled = modelIndex === 0;
            prevBtn.style.opacity = modelIndex === 0 ? '0.5' : '1';
        }
        
        if (nextBtn) {
            nextBtn.disabled = modelIndex === this.availableModels.length - 1;
            nextBtn.style.opacity = modelIndex === this.availableModels.length - 1 ? '0.5' : '1';
        }
    }
