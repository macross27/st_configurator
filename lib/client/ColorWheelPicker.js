export class ColorWheelPicker {
    constructor(canvas, options = {}) {
        ...
        this.updateThrottle = 200; // ~5fps throttle for color updates (extreme performance savings)
    ...
    drawColorWheel() {
        ...
        if (this.wheelCache &&
            ...
            // Use cached version
            this.ctx.putImageData(this.wheelCache.imageData, 0, 0);
            return;
        }
        ...
        // Cache the result for reuse - store as object with metadata
        this.wheelCache = {
            imageData: imageData,
    ...
    handleInteraction(e) {
        ...
        if (distance <= this.radius) {
            ...
            // Throttle color change events
            this.throttledColorChange();
        }
    }
    ...
    throttledColorChange() {
        ...
        // Immediate UI feedback (handle position is already updated)
        // But throttle the expensive color change callbacks
    ...
    handleBrightnessInteraction(e) {
        ...
        // Use throttled color change for brightness too
        this.throttledColorChange();
    }
