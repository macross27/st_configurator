...
class ImageProcessor {
    ...
    /**
     * Comprehensive secure image validation
     * @param {Object} fileData - File data
     * @returns {Object} - Detailed validation result
     */
    validateImageSecurity(fileData) {
        return this.fileValidator.validateFile(fileData);
    }

    /**
     * Validate if file is a supported image (DEPRECATED - use validateImageSecurity)
     * @param {Object} fileData - File data
     * @returns {boolean} - Is valid image
     */
    isValidImage(fileData) {
        console.warn('⚠️  isValidImage() is deprecated. Use validateImageSecurity() for secure validation.');

        // Use secure validation but return simple boolean for backward compatibility
        const validation = this.validateImageSecurity(fileData);
